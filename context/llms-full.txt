...
[![icon picker](https://cdn.coda.io/icons/svg/color/align-center.svg)] (https://docs.videodb.io/)

[![](https://cdn.coda.io/icons/svg/color/quick-mode-on.svg)] (https://docs.videodb.io/quick-start-guide-38)

[![](https://cdn.coda.io/icons/svg/color/wash-your-hands.svg)] (https://docs.videodb.io/how-accurate-is-your-search-88)

[![](https://cdn.coda.io/icons/svg/color/video-call.svg)] (https://docs.videodb.io/video-indexing-guide-101)

[![](https://cdn.coda.io/icons/svg/color/clear-search.svg)] (https://docs.videodb.io/semantic-search-89)

[![](https://cdn.coda.io/icons/svg/color/binders-folder.svg)] (https://docs.videodb.io/collections-68)

[![](https://cdn.coda.io/icons/svg/color/magazine.svg)] (https://docs.videodb.io/public-collections-102)

[![](https://cdn.coda.io/icons/svg/color/callback.svg)] (https://docs.videodb.io/callback-details-66)

[![](https://cdn.coda.io/icons/svg/color/closed-captioning.svg)] (https://docs.videodb.io/ref-subtitle-styles-57)

[![](https://cdn.coda.io/icons/svg/color/customer-support.svg)] (https://docs.videodb.io/language-support-79)

[![](https://cdn.coda.io/icons/svg/color/closed-captioning.svg)] (https://docs.videodb.io/guide-subtitles-73)

[![](https://cdn.coda.io/icons/svg/color/asteroid.svg)] (https://docs.videodb.io/visual-search-and-indexing-80)

[![](https://cdn.coda.io/icons/svg/color/landscape.svg)] (https://docs.videodb.io/scene-extraction-algorithms-84)

[![](https://cdn.coda.io/icons/svg/color/edit-column.svg)] (https://docs.videodb.io/custom-annotations-81)

[![](https://cdn.coda.io/icons/svg/color/search-property.svg)] (https://docs.videodb.io/scene-level-metadata-smarter-video-search-retrieval-107)

[![](https://cdn.coda.io/icons/svg/color/search-more.svg)] (https://docs.videodb.io/advanced-visual-search-pipelines-82)

[![](https://cdn.coda.io/icons/svg/color/football.svg)] (https://docs.videodb.io/playground-for-scene-extractions-83)

[![](https://cdn.coda.io/icons/svg/color/scuba-pressure-gauge.svg)] (https://docs.videodb.io/deep-dive-into-prompt-engineering-mastering-video-scene-indexing-93)

[![](https://cdn.coda.io/icons/svg/color/clear-search.svg)] (https://docs.videodb.io/multimodal-search-90)

[![](https://cdn.coda.io/icons/svg/color/search-more.svg)] (https://docs.videodb.io/multimodal-search-quickstart-91)

[![](https://cdn.coda.io/icons/svg/color/poll-topic.svg)] (https://docs.videodb.io/conference-slide-scraper-with-videodb-92)

[![](https://cdn.coda.io/icons/svg/color/e-learning.svg)] (https://docs.videodb.io/dynamic-video-streams-44)

[![](https://cdn.coda.io/icons/svg/color/text-box.svg)] (https://docs.videodb.io/ref-textasset-74)

[![](https://cdn.coda.io/icons/svg/color/text-box.svg)] (https://docs.videodb.io/guide-textasset-75)

[![director-light](https://codaio.imgix.net/workspaces/ws-jizMKG73gK/blobs/customIcons/6bc288c2-982b-4a97-a402-8da53aeaa236?fit=fill&fill=solid&w=128&h=128&fm=gif&bg=0FFF&fill-color=0FFF)] (https://docs.videodb.io/director-video-agent-framework-98)

[![](https://cdn.coda.io/icons/svg/color/open-book.svg)] (https://docs.videodb.io/agent-creation-playbook-103)

[![](https://cdn.coda.io/icons/svg/color/bag-front-view.svg)] (https://docs.videodb.io/how-i-built-a-crm-integrated-sales-assistant-agent-in-1-hour-106)

[![](https://cdn.coda.io/icons/svg/color/voice-recognition-scan.svg)] (https://docs.videodb.io/make-your-video-sound-studio-quality-with-voice-cloning-105)

[![](https://cdn.coda.io/icons/svg/color/console.svg)] (https://docs.videodb.io/setup-director-locally-104)

[![github](https://codaio.imgix.net/workspaces/ws-jizMKG73gK/blobs/customIcons/ac14f3ef-daa1-4b6e-aba5-af11f11b8372?fit=fill&fill=solid&w=128&h=128&fm=gif&bg=0FFF&fill-color=0FFF)] (https://docs.videodb.io/open-source-tools-94)

[![llama](https://codaio.imgix.net/workspaces/ws-jizMKG73gK/blobs/customIcons/c2b3a994-6140-40a9-93ff-d87aa37f2860?fit=fill&fill=solid&w=128&h=128&fm=gif&bg=0FFF&fill-color=0FFF)] (https://docs.videodb.io/llamaindex-videodb-retriever-58)

[![](https://cdn.coda.io/icons/svg/color/command-line.svg)] (https://docs.videodb.io/promptclip-use-power-of-llm-to-create-clips-52)

[![](https://cdn.coda.io/icons/svg/color/day-camera.svg)] (https://docs.videodb.io/streamrag-connect-chatgpt-to-videodb-43)

[![](https://cdn.coda.io/icons/svg/color/book-and-pencil.svg)] (https://docs.videodb.io/examples-and-tutorials-35)

[![](https://cdn.coda.io/icons/svg/color/audible.svg)] (https://docs.videodb.io/dubbing-replace-soundtrack-with-new-audio-49)

[![](https://cdn.coda.io/icons/svg/color/adware-free.svg)] (https://docs.videodb.io/beep-curse-words-in-real-time-53)

[![](https://cdn.coda.io/icons/svg/color/find-user-male.svg)] (https://docs.videodb.io/remove-unwanted-content-from-videos-5)

[![](https://cdn.coda.io/icons/svg/color/find-and-replace.svg)] (https://docs.videodb.io/instant-clips-of-your-favorite-characters-3)

[![](https://cdn.coda.io/icons/svg/color/insert-white-space.svg)] (https://docs.videodb.io/insert-dynamic-ads-in-real-time-7)

[![](https://cdn.coda.io/icons/svg/color/mac-client.svg)] (https://docs.videodb.io/adding-brand-elements-with-videodb-76)

[![](https://cdn.coda.io/icons/svg/color/adverb.svg)] (https://docs.videodb.io/revolutionize-video-editing-with-videodb-effortless-ad-placement-8)

[![](https://cdn.coda.io/icons/svg/color/medium-volume.svg)] (https://docs.videodb.io/eleven-labs-x-videodb-adding-ai-generated-voiceovers-to-silent-f-59)

[![](https://cdn.coda.io/icons/svg/color/camera-automation.svg)] (https://docs.videodb.io/elevating-trailers-with-automated-narration-60)

[![](https://cdn.coda.io/icons/svg/color/video-trimming.svg)] (https://docs.videodb.io/add-intro-outro-to-videos-61)

[![](https://cdn.coda.io/icons/svg/color/closed-captioning.svg)] (https://docs.videodb.io/enhancing-video-captions-with-videodb-subtitle-styling-62)

[![](https://cdn.coda.io/icons/svg/color/high-volume.svg)] (https://docs.videodb.io/audio-overlay-video-timeline-63)

[![](https://cdn.coda.io/icons/svg/color/video-call.svg)] (https://docs.videodb.io/building-dynamic-video-streams-with-videodb-integrating-custom-d-85)

[![](https://cdn.coda.io/icons/svg/color/for-experienced.svg)] (https://docs.videodb.io/adding-ai-generated-voiceovers-with-videodb-and-lovo-70)

[![](https://cdn.coda.io/icons/svg/color/billboard.svg)] (https://docs.videodb.io/ai-generated-ad-films-for-product-videography-wellsaid-open-ai-v-71)

[![](https://cdn.coda.io/icons/svg/color/search.svg)] (https://docs.videodb.io/fun-with-keyword-search-77)

[![](https://cdn.coda.io/icons/svg/color/find-and-replace.svg)] (https://docs.videodb.io/aws-rekognition-and-videodb-intelligent-video-clips-4)

[![](https://cdn.coda.io/icons/svg/color/find-user-male.svg)] (https://docs.videodb.io/aws-rekognition-and-videodb-effortlessly-remove-inappropriate-co-6)

[![](https://cdn.coda.io/icons/svg/color/counter.svg)] (https://docs.videodb.io/overlay-a-word-counter-on-video-stream-86)

[![](https://cdn.coda.io/icons/svg/color/handle-with-care.svg)] (https://docs.videodb.io/generate-automated-video-outputs-with-text-prompts-dall-e-eleven-87)

[![](https://cdn.coda.io/icons/svg/color/centre-of-gravity.svg)] (https://docs.videodb.io/edge-of-knowledge-10)

[![](https://cdn.coda.io/icons/svg/color/for-experienced.svg)] (https://docs.videodb.io/building-intelligent-machines-16)

[![](https://cdn.coda.io/icons/svg/color/artificial-intelligence.svg)] (https://docs.videodb.io/part-1-define-intelligence-17)

[![](https://cdn.coda.io/icons/svg/color/panel-and-foot-outlet.svg)] (https://docs.videodb.io/part-2-observe-and-respond-18)

[![](https://cdn.coda.io/icons/svg/color/the-flash-sign.svg)] (https://docs.videodb.io/part-3-training-a-model-19)

[![](https://cdn.coda.io/icons/svg/color/cnc-machine.svg)] (https://docs.videodb.io/society-of-machines-20)

[![](https://cdn.coda.io/icons/svg/color/groups.svg)] (https://docs.videodb.io/society-of-machines-23)

[![](https://cdn.coda.io/icons/svg/color/the-flash-sign.svg)] (https://docs.videodb.io/autonomy-do-we-have-the-choice-21)

[![](https://cdn.coda.io/icons/svg/color/artificial-intelligence.svg)] (https://docs.videodb.io/emergence-an-intelligence-of-the-collective-22)

[![](https://cdn.coda.io/icons/svg/color/back-to-draft.svg)] (https://docs.videodb.io/drafts-24)

[![](https://cdn.coda.io/icons/svg/color/one-to-many.svg)] (https://docs.videodb.io/from-language-models-to-world-models-the-next-frontier-in-ai-65)

[![](https://cdn.coda.io/icons/svg/color/recurring-appointment-exception.svg)] (https://docs.videodb.io/the-future-series-78)

[![videodb](https://codaio.imgix.net/workspaces/ws-jizMKG73gK/blobs/customIcons/1a6d553a-3676-494e-8f3b-fd666614f459?fit=fill&fill=solid&w=128&h=128&fm=gif&bg=0FFF&fill-color=0FFF)] (https://docs.videodb.io/building-worlds-first-video-database-25)

[![](https://cdn.coda.io/icons/svg/color/video.svg)] (https://docs.videodb.io/multimedia-from-mp3-mp4-to-the-future-with-videodb-26)

[![](https://cdn.coda.io/icons/svg/color/synchronize.svg)] (https://docs.videodb.io/introducing-videodb-the-pinnacle-of-synchronized-video-streaming-27)

[![](https://cdn.coda.io/icons/svg/color/bridge.svg)] (https://docs.videodb.io/dynamic-video-streams-50)

[![](https://cdn.coda.io/icons/svg/color/need-for-speed.svg)] (https://docs.videodb.io/why-do-we-need-a-video-database-now-41)

[![](https://cdn.coda.io/icons/svg/color/questions.svg)] (https://docs.videodb.io/whats-a-video-database-36)

[![](https://cdn.coda.io/icons/svg/color/ai.svg)] (https://docs.videodb.io/enhancing-ai-driven-multimedia-applications-37)

[![](https://cdn.coda.io/icons/svg/color/artificial-intelligence.svg)] (https://docs.videodb.io/misalignment-of-todays-web-67)

[![](https://cdn.coda.io/icons/svg/color/fff.svg)] (https://docs.videodb.io/beyond-traditional-video-infrastructure-28)

[![](https://cdn.coda.io/icons/svg/color/biotech.svg)] (https://docs.videodb.io/research-grants-96)

[![](https://cdn.coda.io/icons/svg/color/the-dragon-team.svg)] (https://docs.videodb.io/team-46)

[![videodb](https://codaio.imgix.net/workspaces/ws-jizMKG73gK/blobs/customIcons/1a6d553a-3676-494e-8f3b-fd666614f459?fit=fill&fill=solid&w=128&h=128&fm=gif&bg=0FFF&fill-color=0FFF)] (https://docs.videodb.io/internship-build-the-future-of-ai-powered-video-infrastructure-97)

[![](https://cdn.coda.io/icons/svg/color/light.svg)] (https://docs.videodb.io/ashutosh-trivedi-32)

[![](https://cdn.coda.io/icons/svg/color/fast-forward.svg)] (https://docs.videodb.io/playlists-33)

[![](https://cdn.coda.io/icons/svg/color/1.svg)] (https://docs.videodb.io/talks-solving-logical-puzzles-with-natural-language-processing-p-34)

[![](https://cdn.coda.io/icons/svg/color/rocket.svg)] (https://docs.videodb.io/ashish-45)

[![](https://cdn.coda.io/icons/svg/color/edvard-munch.svg)] (https://docs.videodb.io/shivani-desai-48)

[![](https://cdn.coda.io/icons/svg/color/artificial-intelligence.svg)] (https://docs.videodb.io/gaurav-tyagi-51)

[![](https://cdn.coda.io/icons/svg/color/under-computer.svg)] (https://docs.videodb.io/rohit-garg-64)

[![](https://cdn.coda.io/icons/svg/color/like.svg)] (https://docs.videodb.io/customer-love-42)

[![](https://cdn.coda.io/icons/svg/color/llama.svg)] (https://docs.videodb.io/temp-doc-54)
...
![Multiple Indexes.png](https://codaio.imgix.net/docs/_s5lUnUCIU/blobs/bl-ipnspuoNXW/79b0a70998275eb92411e6258de3afef749a5116181c895a50f9273ccf13f714c434cf1e52ec93d5b26832152a1bb3441a7d2125ed788289da4caa88650cd9c18132640Ddac62d0835fb77863c8f04fb9137b7c9a44a74479a3c4a153d96df2fb0b1f4c0?auto=format%2Ccompress&fit=max)
...
[Colab Notebook](https://colab.research.google.com/github/video-db/videodb-cookbook/blob/main/guides/multimodal/Prompt_Experiments_and_Benchmarking.ipynb)
...
Our primary objective was to demonstrate how refined prompts can significantly improve search results and information extraction from video content. We aimed to create a system capable of accurately identifying objects, actions, and even emotions in various video scenes. For this particular experiment, we used video footage from a [dog show](https://youtu.be/_T3n-2zOrZQ?si=lY9JnkKPQq1WhwMk), featuring various breeds walking down a runway with their handlers, surrounded by spectators and photographers. Our goal was to create prompts that could answer detailed queries like "Show me the happiest moments featuring a Golden Retriever" with high precision.
...
### Frame Prompt 1: Basic animal identification
...
### Frame Prompt 2: Enhanced breed identification and spatial information
...
### Scene Prompt 1: Basic scene-level prompt
...
### Scene Prompt 2: Combining frame-level specifications in scene-level prompt
...
### Scene Prompt 3: Ensuring correct breed identification in context of environment
...
### Scene Prompt 4: Structured JSON output with emotional states
...
We would love to see your experiments and hear about your prompting experiences. Join our [Discord community](https://discord.gg/py9P639jGz) to share and learn 🖖
...
# IPYNB Notebook: Scene Index QuickStart
...
This guide provides a quick introduction to scene indexing using VideoDB. Scene indexing leverages computer vision models to extract meaningful information from video frames, allowing you to easily search and retrieve specific moments within your video library. With VideoDB, you can build powerful applications such as:

*   **Visual Search:** Quickly find relevant scenes based on content.
*   **RAG (Retrieval-Augmented Generation) for Video:** Answer questions about video content using scene-level information.
*   **Content Analysis:** Automatically analyze video content for key events, objects, or activities.

Here's an example of how scene indexing can be used to answer queries about video content:
...
To connect to VideoDB, you'll need an API key. Set the `VIDEO_DB_API_KEY` environment variable with your key:
...
Upload a video to VideoDB using a URL.  For this example, we will upload a video from YouTube:
...
The `index_scenes` function automatically indexes visual information within your video.  This creates descriptions for different sections of the video, allowing for easy searching later.
...
The `index_scenes()` function provides several optional parameters to customize the indexing process:

*   **`extraction_type`**:  Specifies the algorithm used to select scenes and frames.
*   **`extraction_config`**:  Provides configuration options for the selected extraction algorithm.
*   **`prompt`**:  A prompt used by a vision model to generate textual descriptions of scenes and frames.
*   **`callback_url`**:  A URL to receive a notification when the indexing job is complete.

For a deeper dive into scene and frame objects, refer to the [Advanced Visual Search Guide](https://github.com/video-db/videodb-cookbook/blob/main/guides/video/scene-index/advanced_visual_search.ipynb).
...
The output will be a list of dictionaries, each representing a scene within the video:
...
> **Note:** It may take a few seconds for your index to become available for searching.

Now that you have indexed the video scenes, you can search it by `index_id`, `index_type`, and provide a `query`
...
This will return a playable snippet of the video where the query term "religious gathering" is found.

## ⚙️ Scene Indexing Parameters Explained

---

The `index_scenes` function provides flexible configuration through these parameters:
...
*   `prompt`:  Provides a text prompt for the vision model to generate descriptions.
*   `callback_url`:  Specifies a URL for receiving job completion notifications.

Let's examine each parameter in detail:

### ⚙️ `extraction_type` & `extraction_config`

A video is essentially a sequence of images displayed over time.  The `extraction_type` parameter allows you to select the algorithm used to determine scene boundaries and extract representative frames.  Different algorithms may be more suitable depending on the type of video content. The `extraction_config` parameter then allows for further customization of the selected algorithm. Refer to the [Scene Extraction Algorithms Documentation](https://docs.videodb.io/scene-extraction-algorithms-84) for comprehensive information.

![](https://raw.githubusercontent.com/video-db/videodb-cookbook/main/images/scene_index/VSF.png)

### ⚙️ `prompt`

The `prompt` parameter guides the vision model in understanding the context and desired output. For instance, to identify running activity, you could use the prompt:

> "Describe clearly what is happening in the video. Add running_detected if you see a person running."

To experiment with custom models and prompts, see the [Advanced Visual Search Pipelines Guide](https://github.com/video-db/videodb-cookbook/blob/main/guides/scene-index/advanced_visual_search.ipynb).

### ⚙️ `callback_url`

The `callback_url` parameter allows you to specify a URL to receive a notification when the scene indexing process completes. See the [Callback Details Documentation](https://docs.videodb.io/callback-details-66#_lubHL) for more information.
...
> **💡** You can create multiple scene indexes for a single video. This allows you to experiment with different indexing parameters and prompts to optimize search results for specific use cases. You can also rank results from different indexes before displaying them to your users.

**Listing Scene Indexes:**

The `video.list_scene_index()` function returns a list of available scene indexes for a video, including their `id`, `name`, and `status`:
...
The `video.get_scene_index()` function retrieves a specific scene index based on its `scene_index_id`.  It returns a list of indexed scenes, including their `start` time, `end` time, and `description`:
...
```
[{'description': 'The image depicts a man sitting in an office or conference room...', 'end': 10.01, 'start': 0.0},
 {'description': 'The image shows a man with a receding hairline, wearing a dark suit...', 'end': 20.02, 'start': 10.01},
 ... ]
```

**Deleting an Index:**

The `video.delete_scene_index()` function removes a scene index:
...
*   **Custom Annotations Pipeline:** [Custom Annotations Guide](https://github.com/video-db/videodb-cookbook/blob/main/guides/scene-index/custom_annotations.ipynb) -  Learn how to incorporate your own scene descriptions and annotations.
*   **Scene Extraction Playground:** [Playground for Scene Extractions](https://github.com/video-db/videodb-cookbook/blob/main/guides/scene-index/playground_scene_extraction.ipynb) - Experiment with different extraction algorithms and prompts.
*   **Advanced Visual Search Pipelines:** [Advanced Visual Search Pipelines](https://github.com/video-db/videodb-cookbook/blob/main/guides/scene-index/advanced_visual_search.ipynb) - Create flexible and powerful visual search solutions.
...
# IPYNB Notebook: VideoDB Quickstart

```python
# @title ⚡️ QuickStart: VideoDB
# @markdown This notebook is designed to help you get started with [VideoDB](https://videodb.io).
...
# @markdown ##### 🔗 Setting Up a Connection to VideoDB
# @markdown To connect to VideoDB, create a `Connection` object. You can provide your VideoDB API key directly to the constructor or set the `VIDEO_DB_API_KEY` environment variable.
...
# @markdown Now that you have a connection to VideoDB, upload videos using `conn.upload()`. Upload media by a public `url` or from a `file_path`. `upload` returns a `Video` object for accessing video methods.
...
# @markdown VideoDB simplifies uploads by supporting links from YouTube, S3, or any public URL.
# @markdown </div>

# @markdown <div style="height:15px;"></div>

# @markdown #### 📺 View Your Video
# @markdown Your video is instantly available for viewing in 720p resolution! ⚡️
...
# @markdown <div style="background-color: #ffffcc; color: black; padding: 10px; border-radius: 5px;">
# @markdown <strong>Note:</strong> If viewing this notebook on GitHub, you won't see the iframe player due to security restrictions. Please open the printed link in your browser.
# @markdown </div>
...
# @markdown ```
# @markdown 'https://console.videodb.io/player?url=https://stream.videodb.io/v3/published/manifests/0645b883-5e48-4136-a5bc-f046b3a166a2.m3u8'
# @markdown ```

# @markdown #### ✂️ Get Specific Sections of Videos
# @markdown Easily clip sections of a video by specifying start and end times (in seconds) in a `timeline`.

# @markdown For example, streaming the first 10 seconds and then seconds 120-140 of the uploaded video:
...
# @markdown ```
# @markdown 'https://console.videodb.io/player?url=https://stream.videodb.io/v3/published/manifests/d0a049ff-be6e-41f7-826e-4a6e411f7bab.m3u8'
# @markdown ```

# @markdown <div style="height:15px;"></div>

# @markdown #### 🔍 Indexing a Video
# @markdown To search within a video, first index it. Invoke the `index` function on the `Video` object. VideoDB offers two index types:

# @markdown 1.  `index_spoken_words`: Indexes spoken words, automatically generating a transcript for searching. Supports 20+ languages. See [Language Support](https://docs.videodb.io/language-support-79).
# @markdown 2.  `index_scenes`: Indexes visual information. Ideal for finding scenes, activities, objects, and emotions. See [Scene Index Documentation](https://docs.videodb.io/scene-index-documentation-80).

# @markdown <div style="background-color: #ffffcc; color: black; padding: 10px; border-radius: 5px;">
# @markdown <strong>Note:</strong> Indexing can take time for longer videos.
# @markdown </div>
...
# @markdown ```
# @markdown 100%|████████████████████████████████████████████████████████████████████████████████████████████████████| 100/100 [00:18<00:00,  5.40it/s]
# @markdown ```

# @markdown ```python
# Index visual information in video frames. Adjust the prompt for your use case.
...
This guide demonstrates how to customize subtitle styles using the `SubtitleStyle` class in VideoDB.  We'll explore visual examples of various configurations, including:

*   **Typography and Style:** Font, size, spacing, and text decorations.
*   **Color and Effects:**  Primary, secondary, outline, and background colors with transparency.
*   **Positioning and Margins:** Alignment and margins for precise placement.
*   **Text Transformation:** Scaling and rotation for creative effects.
...
To use VideoDB, you need an API key.

> Get your free API key from the [VideoDB Console](https://console.videodb.io) (Free for the first 50 uploads, no credit card required!). 🎉
...
Upload a base video to which you want to add subtitles.  We'll use a sample video for this guide:
...
This will display the video in an interactive player. The player URL will also be returned.
...
Before adding subtitles, index the spoken words in the video using `video.index_spoken_words()`. This generates the transcript used for subtitles.
...
The simplest way to add subtitles is using `Video.add_subtitle()`.  This uses default styling.

The method returns a streaming link. Use `play_stream()` to view the video with subtitles.
...
To customize subtitle appearance, pass a `SubtitleStyle()` object with your desired configurations to `Video.add_subtitle()`.

> ℹ️ Refer to the [API Reference](link_to_api_reference) for the `SubtitleStyle` class for comprehensive details.

### 1. Typography and Style

Configure the typography of subtitles using these `SubtitleStyle()` parameters:

*   `font_name`:  The font name (e.g., "Roboto", "Arial").
*   `font_size`: The font size in pixels (e.g., 12).
*   `spacing`:  The spacing between characters in pixels (e.g., 0).
*   `bold`: Set to `True` for bold text.
*   `italic`: Set to `True` for italic text.
*   `underline`: Set to `True` for underlined text.
...
Customize subtitle colors using these `SubtitleStyle()` parameters:

*   `primary_colour`: The color of the main subtitle text.
*   `secondary_colour`: A color used for karaoke effects or other secondary highlights.
*   `outline_colour`: The color of the text outline.
*   `back_colour`: The color of the subtitle background.

> **ℹ️ Color Format**
>
> `SubtitleStyle` accepts colors in the `&HBBGGRR` hexadecimal format. This represents blue, green, and red components. The `&H` prefix is mandatory.  To add transparency, include an alpha value at the beginning: `&HAABBGGRR`.  (AA = Alpha, BB = Blue, GG = Green, RR = Red)
...
Adjust subtitle alignment and position using these `SubtitleStyle()` parameters:

*   `alignment`:  The alignment of the subtitle. Use the `SubtitleAlignment` enum.
*   `margin_l`:  The margin (in pixels) on the left side of the subtitle box.
*   `margin_r`:  The margin (in pixels) on the right side of the subtitle box.
*   `margin_v`:  The margin (in pixels) at the top and bottom of the subtitle box.

> ℹ️ See the [API Reference](link_to_api_reference) for details on `SubtitleAlignment` options.
...
Transform the text size and angle with these `SubtitleStyle()` parameters:

*   `scale_x`:  The horizontal scaling factor for the font.
*   `scale_y`:  The vertical scaling factor for the font.
...
*   `border_style`: The border style of the subtitle. Use the `SubtitleBorderStyle` enum.
*   `outline`: The width (in pixels) of the outline around the text.
*   `shadow`: The depth (in pixels) of the shadow behind the text.

> ℹ️ Refer to the [API Reference](link_to_api_reference) for more information on `SubtitleBorderStyle` options.
...
Explore more resources and tutorials on VideoDB subtitles:

*   [Enhancing Video Captions with VideoDB Subtitle Styling](https://coda.io/d/_dnIYgjBK4eB/_sulRy)
*   [Link to reference](link_to_api_reference) - *Placeholder, add the correct API reference link*
...
* **Clearer Language:**  Replaced phrases like "gives you an introduction" with more direct language like "demonstrates how to".
* **Conciseness:** Removed redundant phrases and focused on the core information.  For example, removed "by passing following parameters" because the structure of the sections already implies this.
* **Formatting:** Improved formatting with consistent use of headers, bullet points, and code blocks.  Added blank lines to improve readability.
* **Explanatory Comments:** Added comments in the code where necessary to clarify what each step does.
* **API Reference Placeholder:** Added `link_to_api_reference` as a placeholder in two places so the user knows exactly where to link the actual API reference when they have it.  Mentioning the API reference multiple times encourages the user to check it.
* **Transparency Explanation:**  Clarified the `&HAABBGGRR` color format, specifically explaining what the "AA" represents (Alpha/transparency).
* **Environment Variable Clarification:** Added a comment directly in the `os.environ` line to remind the user to replace the empty string with their API key.
* **Removed Redundancy:**  The repeated "Accepts a value a type" was simplified to just "Use the `SubtitleAlignment` enum." or "Use the `SubtitleBorderStyle` enum."
* **Consistent Terminology:** Used "parameter" and "method" consistently for technical terms.
* **Emphasis on Free Tier:**  Kept the mention of the free tier prominent to encourage adoption.
* **Clearer Instructions:** For example, replaced "View API Reference" with a more helpful "Refer to the [API Reference] for the `SubtitleStyle` class for comprehensive details."
* **Actionable Language:** "Explore more resources..." is more inviting than "Check out the other resources".
* **Removed Unnecessary Bolding:**  Only bolded important points or section headers, making the text less visually cluttered.
* **Consistent Code Formatting:** Ensured that all code snippets are consistently formatted for readability.
* **Added Comments in Code:** Added comments in the code to explain what each line does. This helps the user understand the code better and modify it according to their needs.
* **Clearer Explanation of `video.play()`:** Added that `video.play()` displays the video in an interactive player, and returns the player URL.
* **Placeholder for API Reference:** Added placeholders `link_to_api_reference` where the link to the API reference should be added.
* **Removed unnecessary "ℹ️" and other visual clutter.**  Replaced with more direct and cleaner formatting.

This refined version provides a more accessible and user-friendly guide to using VideoDB subtitles.


---

# IPYNB Notebook: Cleanup
...
⚠️ **WARNING: This notebook will PERMANENTLY DELETE media files from your VideoDB account. This action is irreversible.** ⚠️

🚨 **IMPORTANT: Before running any deletion commands, carefully review the media files you intend to delete.** 🚨

This guide provides instructions on how to remove media files (videos, audio, and images) from your VideoDB account to manage storage. You'll learn how to:
...
Before proceeding, ensure you have access to your VideoDB API key.
...
This step helps you identify the collection you want to clean up.
...
Replace `"YOUR_COLLECTION_ID_HERE"` with the ID of the collection you want to clean up.
...
This guide introduces `TextAssets` and demonstrates how to use them to overlay text elements on your videos with VideoDB.

We will explore the available configurations for the `TextAsset` class, including:
...
VideoDB uses video as a foundation for creating timelines. Click here to learn more about how [Timelines and Assets](https://docs.videodb.io/timeline-and-assets-44) function.
...
*   `TextAsset`:  The text element we'll overlay on the video.

> Check out [Timelines and Assets](https://docs.videodb.io/timeline-and-assets-44) for more information.
...
> View the API Reference for [`TextStyle`](https://docs.videodb.io/reference/textstyle) for all available styling options.
...
# Create a TextAsset with custom font styling using TextStyle
...
![Text Asset with Font Styling](https://github.com/video-db/videodb-cookbook-assets/raw/main/images/guides/text-asset/font_styling.png)
...
# Create a TextAsset with a custom background box using TextStyle
...
![Text Asset with Background Box](https://github.com/video-db/videodb-cookbook-assets/raw/main/images/guides/text-asset/background_box.png)
...
# Create a TextAsset with a custom shadow using TextStyle
...
![Text Asset with Shadow](https://github.com/video-db/videodb-cookbook-assets/raw/main/images/guides/text-asset/custom_shadow.png)
...
![Vertical Alignment Text](https://github.com/video-db/videodb-cookbook-assets/raw/main/images/guides/text-asset/y_align.png)
